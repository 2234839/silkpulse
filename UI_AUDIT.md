...
| F2  | ObjectInspector 展开对象时，原型链方法（**defineGetter**/hasOwnProperty/…）与自有属性平铺混排，自有字段被淹没                               | ObjectInspector.vue + shared SerializedProperty.inherited + sdk serialize-value | ✅ 已修：继承属性打 inherited 标记，展示层折叠进 [[Prototype]] 分组（74 截图验证）                                                                  |
