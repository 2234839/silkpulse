...
<template>
  ...
  <AuthPage
    ...
    :guest-projects-enabled="authStatus?.guestProjectsEnabled"
    :on-guest-create-project="handleGuestCreateProject"
  />
  ...
  <div v-else class="h-screen flex flex-col">
    ...
    <AgentPromptModal
      ...
      :api-key="apiKey || ''"
      :is-guest-project="isGuestProject"
      :project-expires-at="projectExpiresAt"
    />
  </div>
</template>
