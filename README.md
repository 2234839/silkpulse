...
- `__clarosight_setValue(idx, val)` — 设置表单值（框架兼容，**支持 input/textarea/select 三类元素**）
...
└── scripts/
    └── headless-test.mjs # 无头浏览器端到端测试（77 项）
```
